...
![**Figure 7.** HMM-decoded regimes for the S&P 500, 2018 to 2024, with the March 2020 and August 2024 windows marked. Source: outputs/figures/fig_hmm_regimes_sp500.png, generated by robustness/regime_detection.py.](outputs/figures/fig_hmm_regimes_sp500.png){width=85%}
...
![**Figure 8.** HMM-decoded regimes for the Nikkei 225, with the August 2024 window marked. Source: outputs/figures/fig_hmm_regimes_nikkei.png, generated by robustness/regime_detection_carry.py.](outputs/figures/fig_hmm_regimes_nikkei.png){width=85%}
...
The USD/JPY regime classification and the GARCH conditional-volatility series for all four instruments are available in the project repository.
